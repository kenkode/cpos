            ...
            <table id="example1" class="table table-bordered table-hover">
                ...
                <tr>
                  ...
                  <ul class="dropdown-menu" role="menu">
                    ...
                    <li><a href="{{URL::to('waiter/orderitem/return/'.$orderitem->id)}}" onclick="return (confirm('Are you sure you want to return this order?'))">Return</a></li>
                    @endif
                    @if($orderitem->is_cancelled == 0)
                    <li><a href="{{URL::to('waiter/orderitem/cancel/'.$orderitem->id)}}" onclick="return (confirm('Are you sure you want to cancel this order?'))">Cancel</a></li>
                    @endif
                  </ul>
              </div>
