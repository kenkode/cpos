...
$orders = App\Order::whereDate('created_at',date('Y-m-d'))->orderBy('id','DESC')->get();
$neworders = App\Order::whereDate('created_at',date('Y-m-d'))->get();
?>
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown notifications-menu">
            <a href="{{URL::to('/neworders')}}" class="dropdown-toggle" data-toggle="dropdown">
              <i class="fa fa-bell-o"></i>
              <span id="notification" class="label label-warning">{{count($neworders)}}</span>
            </a>
            <ul class="dropdown-menu">
              <li id="message" class="header">You have {{count($neworders)}} new orders</li>
              
              <li class="footer"><a href="{{URL::to('/neworders')}}">View new orders</a></li>
            </ul>
          </li>
          ...
          <li class="dropdown tasks-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span id="pending" class="label label-danger">{{count($orders)}}</span>
            </a>
            <ul class="dropdown-menu">
              <li id="pendingmessage" class="header">You have {{count($orders)}} pending orders</li>
              
              <li class="footer">
                <a href="{{URL::to('/')}}">View pending orders</a>
              </li>
            </ul>
          </li>
          <!-- Tasks: style can be found in dropdown.less -->
          ...
          <li class="dropdown user user-menu" style="margin-top: -2px">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              @if(Auth::user()->photo != null || Auth::user()->photo != '')
                <img src="{{asset('images/'.Auth::user()->photo)}}" class="img-circle" width="20" height="20" alt="User Image">
                @else
          ...
          <li>
            <a href="{{URL::to('setting')}}"><i class="fa fa-gears"></i></a>
          </li>
        </ul>
      </div>
    </nav>
