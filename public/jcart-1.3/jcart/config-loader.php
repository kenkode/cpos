...
if (!$config['currencyCode']) $config['currencyCode']                     = 'KSH';
if (!$config['text']['cartTitle']) $config['text']['cartTitle']           = 'Requested Meals';
...
if (!$config['text']['checkout']) $config['text']['checkout']             = 'Send order';
if (!$config['text']['checkoutPaypal']) $config['text']['checkoutPaypal'] = 'Checkout with PayPal';
if (!$config['text']['removeLink']) $config['text']['removeLink']         = 'X';
if (!$config['text']['emptyButton']) $config['text']['emptyButton']       = 'Clear';
