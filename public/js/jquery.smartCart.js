...
;(function ($, window, document, undefined) {
    ...
    var defaults = {
        ...
        currencySettings: {
            locales: 'sw-KE', // A string with a BCP 47 language tag, or an array of such strings
            currencyOptions: {
                style: 'currency',
                currency: 'KSH',
    ...
    $.extend(SmartCart.prototype, {
        ...
        _setElements: function () {
            ...
            this.cart_element.append('<div class="panel-heading sc-cart-heading" style="background: #2389bb; color: #fff">' + this.options.lang.cartTitle + ' <span class="sc-cart-count badge">0</span></div>');
        ...
        _setEvents: function () {
            ...
            $(this.options.addCartSelector).on("click", function (e) {
                ...
                $.ajax({
                    url: "/rpos/public/cart",
                    data: { 
                            "product": p
                          },
                    type: "post",
                    success: function(data){
                               p = mi._addToCart(data);
                               p = localStorage.setItem(p);
